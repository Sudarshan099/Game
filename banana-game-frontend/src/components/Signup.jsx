            ...
            <div className="flex items-center justify-center min-h-screen p-4"
                ...
                <div className="flex flex-col md:flex-row shadow-[#6d325c] shadow-xl hover:drop-shadow-2xl rounded-lg overflow-hidden bg-[#fadcd5] w-full max-w-lg">
                    <div className="w-full md:w-full p-8 md:p-12 flex flex-col justify-center">
                        <h2 className="flex justify-center text-2xl md:text-3xl font-bold mb-6 text-center md:text-left">Register to Kera 🍌</h2>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <button type="button" onClick={handleLogClick} className="w-full mt-4 text-blue-500 hover:underline">
                                Back to Login
                            </button>
                        </form>
                    </div>
